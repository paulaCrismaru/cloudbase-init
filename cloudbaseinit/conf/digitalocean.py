...
"""Config options available for the DigitalOcean metadata service."""
...
class DigitalOceanOptions(conf_base.Options):

    """Config options available for the DigitalOcean metadata service."""

    def __init__(self, config):
        super(DigitalOceanOptions, self).__init__(config, group="digitalocean")
        self._options = [
            cfg.StrOpt(
    ...
    def register(self):
        ...
        group = cfg.OptGroup(self.group_name, title='DigitalOcean Options')
